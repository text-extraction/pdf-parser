...
import textextraction.pdfparser.operator.graphic.ClipNonZeroRule;
import textextraction.pdfparser.operator.graphic.ClosePath;
import textextraction.pdfparser.operator.graphic.CurveTo;
import textextraction.pdfparser.operator.graphic.CurveToReplicateFinalPoint;
import textextraction.pdfparser.operator.graphic.CurveToReplicateInitialPoint;
import textextraction.pdfparser.operator.graphic.DrawObject;
import textextraction.pdfparser.operator.graphic.EndPath;
import textextraction.pdfparser.operator.graphic.FillEvenOddAndStrokePath;
import textextraction.pdfparser.operator.graphic.FillEvenOddRule;
import textextraction.pdfparser.operator.graphic.FillNonZeroAndStrokePath;
import textextraction.pdfparser.operator.graphic.FillNonZeroRule;
import textextraction.pdfparser.operator.graphic.LineTo;
import textextraction.pdfparser.operator.graphic.ModifyCurrentTransformationMatrix;
import textextraction.pdfparser.operator.graphic.MoveTo;
import textextraction.pdfparser.operator.graphic.RestoreGraphicsState;
import textextraction.pdfparser.operator.graphic.SaveGraphicsState;
import textextraction.pdfparser.operator.graphic.SetGraphicsStateParameters;
import textextraction.pdfparser.operator.graphic.StrokePath;
import textextraction.pdfparser.operator.text.BeginText;
import textextraction.pdfparser.operator.text.EndText;
import textextraction.pdfparser.operator.text.MoveText;
import textextraction.pdfparser.operator.text.MoveTextSetLeading;
import textextraction.pdfparser.operator.text.MoveToNextLine;
import textextraction.pdfparser.operator.text.MoveToNextLineAndShowText;
import textextraction.pdfparser.operator.text.MoveToNextLineAndShowTextWithSpacing;
import textextraction.pdfparser.operator.text.SetCharacterSpacing;
import textextraction.pdfparser.operator.text.SetFontAndSize;
import textextraction.pdfparser.operator.text.SetTextHorizontalScaling;
import textextraction.pdfparser.operator.text.SetTextLeading;
import textextraction.pdfparser.operator.text.SetTextMatrix;
import textextraction.pdfparser.operator.text.SetTextRenderingMode;
import textextraction.pdfparser.operator.text.SetTextRise;
import textextraction.pdfparser.operator.text.SetType3GlyphWidthAndBoundingBox;
import textextraction.pdfparser.operator.text.SetWordSpacing;
import textextraction.pdfparser.operator.text.ShowText;
import textextraction.pdfparser.operator.text.ShowTextWithIndividualGlyphPositioning;
